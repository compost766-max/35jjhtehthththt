...
price = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [InlineKeyboardButton(text='📂 Подарок от форестова', callback_data='giftfor'), InlineKeyboardButton(text='📂 Приват', callback_data='privat')  ],
        [InlineKeyboardButton(text='📂 Премиум эмодзи', url="https://t.me/Frezix_emodzi/4")]
    ]
)

privaty = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text='📂 Приват АЕ №1', url="https://t.me/privqae/10")],
        [InlineKeyboardButton(text='📂 Приват АЕ №2', callback_data='aeprivs')],
        [InlineKeyboardButton(text='📂 Приват по Эдитам', callback_data='editpriv')],
...
woterae = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [InlineKeyboardButton(text='💧 Водяной знак №21', url='https://t.me/operotovwm/195'), InlineKeyboardButton(text='💧 Водяной знак №22', url='https://t.me/operotovwm/197')],
        [InlineKeyboardButton(text='💧 Водяной знак №23', url='https://t.me/operotovwm/207'), InlineKeyboardButton(text='💧 Водяной знак №24', url='https://t.me/operotovwm/209')],
        [InlineKeyboardButton(text='💧 Водяной знак №25', url='https://t.me/operotovwm/216')],
...
woternd = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text='👉 Нажми 👈', callback_data='vdnodes')],
